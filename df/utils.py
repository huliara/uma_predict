...
def kyoso_joken_mapper(kyoso_joken: str):
    if (kyoso_joken == "703") | (kyoso_joken == "702"):
        return 0
    elif kyoso_joken == "005":
        return 1
    elif kyoso_joken == "010":
        return 2
    elif kyoso_joken == "016":
        return 3
    elif kyoso_joken == "999":
        return 4
    else:
        return 0
...
def chakusa_num_v2(chakusa_list: list):
    ...
    for index, chakusa in enumerate(chakusa_list):
        if chakusa == "D  ":
            ...
            chakusa_num[index] = 0.05
        elif chakusa == "312":
            chakusa_num[index] = 0.03
        elif chakusa == "4  ":
            chakusa_num[index] = 0.018
